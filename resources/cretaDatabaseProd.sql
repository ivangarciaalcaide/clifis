...
-- Volcando estructura de base de datos para clifisBD
DROP DATABASE IF EXISTS `clifisBD`;
CREATE DATABASE IF NOT EXISTS `clifisBD` /*!40100 DEFAULT CHARACTER SET utf8
...
-- Volcando estructura para tabla clifisBD.Cita
...
-- Volcando estructura para tabla clifisBD.Consulta
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla clifisBD.Especialidad
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla clifisBD.HistorialMedico
...
(
  ...
  FOREIGN KEY (H_IdMedico) REFERENCES clifisBD.Medico (Med_Id)
    ON UPDATE CASCADE
    ON DELETE CASCADE,
  CONSTRAINT HistorialMedico_Especialidad_Es_Id_fk
  FOREIGN KEY (H_IdEspecialidad) REFERENCES clifisBD.Especialidad (Es_Id)
    ON UPDATE CASCADE
    ON DELETE CASCADE,
  CONSTRAINT HistorialMedico_Paciente_Pac_Id_fk
  FOREIGN KEY (H_IdPaciente) REFERENCES clifisBD.Paciente (Pac_Id)
    ON UPDATE CASCADE
    ON DELETE CASCADE
);
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla clifisBD.Medico
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla clifisBD.Medico_Especialidad
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla clifisBD.Paciente
